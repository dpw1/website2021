  ...
  if (!_xnext_included && !window.location.href.match(/fb_xd_fragment/g)) {
    ...
    ;(function () {
      ...
      tryInjectRosettaScript(
        "https://d2scn539ulxr09.cloudfront.net/rosetta/translations/new-frontend/files/new-frontend.en.1813910338.js"
      )
    })()
    ;(function () {
      window.ecwid_init_elm_config = function () {
        function load() {
          ...
          script.src = selectJsVersion(
            "https://d2scn539ulxr09.cloudfront.net/venera/static/ecwid-storefront.b4efc0fdae67b1412289fe28b59c00ae.min.js"
          )
          document.getElementsByTagName("head")[0].appendChild(script)
        }
        function loadCheckout(callback) {
          ...
          script.src = selectJsVersion(
            "https://d2scn539ulxr09.cloudfront.net/venera/static/ecwid-checkout.96c09e6418fb7db11c2e9959e516856d.min.js"
          )
          document.getElementsByTagName("head")[0].appendChild(script)
    ...
    function getHeadTag() {
      ...
      if (!head) {
        head = document
          ...
          .parentNode.appendChild(document.createElement("head"))
      }
      return head[0]
    }
    window.Ecwid = {
      ...
      OnPageSwitch: new ep(),
      signature: "166049fff82c54361f5d39d07a29301e-0",
      ...
      _injectEcwidCss: function () {
        ...
        ChameleonIntegration = {
          ...
          getLinkColor: function (parent) {
            ...
            var primary_link = document.defaultView.getComputedStyle(a, null)
              .color
          ...
          getStyle: function (e, a) {
            ...
            if (!v && e.currentStyle) v = e.currentStyle[this.toCamelCase(a)]
            return v
          },
        ...
        window.ec_legacyCssUrl =
          "https://d1oxsl77a1kjht.cloudfront.net/css/new/cut?hc=1985359125&ownerid=61271341&useProximaNovaFont=true" +
          cssUrlAddition
        var cssUrl =
          "https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1985359125&ownerid=61271341&useProximaNovaFont=true" +
          cssUrlAddition
    ...
    <div class="ecwid-pb-placeholder__product"></div><div class="ecwid-pb-placeholder__title"><div></div><div></div><div></div></div>\
        ...
        ;(function () {
          var getRGB = function (b) {
            ...
            if (
              (a = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(b))
            )
              return [
                parseInt(a[1], 16),
                parseInt(a[2], 16),
          ...
          if (useStubbedVersion) {
            ...
            ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub = function () {
              var U = "bootstrap",
                ...
                gb = "<!doctype html>",
                hb = "",
                ib = "<html><head></head><body></body></html>",
                jb = "undefined",
                kb = "readystatechange",
                lb = 10,
                mb = "script",
                nb = "function",
                ob = "javascript",
                pb = "ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub",
                qb = "Failed to load ",
                rb = "moduleStartup",
                sb = "scriptTagAdded",
                tb = "moduleRequested",
                ub = "meta",
                vb = "name",
                wb = "ru.cdev.xnext.legacyfrontendstub.LegacyFrontendStub::",
                xb = "::",
                yb = "gwt:property",
                zb = "content",
                Ab = "=",
                ...
                ic = "22D3E6687781949AF3C9CB26C52DF87B",
                jc = "3A6AE8F4B915A84D7A85D32DFFC5EFA2",
                kc = "5BBE594489CE14644F0140E6EE3B7930",
                lc = "7D55A024E7879893B01225680E28BA92",
                mc = "E16B0B086D4864C3740EB0F5FEBA7AD3",
                nc = ":",
                oc = ".cache.js",
                pc = "loadExternalRefs",
                qc = "end",
                ...
                Cc = 300,
                Dc = 100,
                Ec = "ecwid-loadingIndicator-cursor",
                Fc = "style"
              var o
              var p = window
              var q = document
              ...
              u[Y] = { moduleName: Y }
              ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__moduleStartupDone = function (
                e
              ) {
                var f = u[Y].bindings
              ...
              function B() {
                ...
                var a = q.createElement(bb)
                a.id = Y
                a.className = cb
                a.style.cssText = db + eb
                a.tabIndex = -1
                q.body.appendChild(a)
                v = a.contentWindow.document
                v.open()
                var b = document.compatMode == fb ? gb : hb
                v.write(b + ib)
                v.close()
              }
              function C(f) {
                function g(a) {
                  function b() {
                    if (typeof q.readyState == jb) {
                      return typeof q.body != jb && q.body != null
                    }
                  ...
                  function d() {
                    if (!c) {
                      ...
                      if (q.removeEventListener) {
                        q.removeEventListener(kb, d, false)
                      }
                      if (e) {
                        clearInterval(e)
                      }
              ...
              ru_cdev_xnext_legacyfrontendstub_LegacyFrontendStub.__startLoadingFragment = function (
                a
              ) {
                return H(a)
              }
              ...
              function F() {
                ...
                var d
                var e
                var f = q.getElementsByTagName(ub)
                for (var g = _, h = f.length; g < h; ++g) {
                  var j = f[g],
                    k = j.getAttribute(vb),
                    l
                  if (k) {
              ...
              function G() {
                if (window.ecwid_script_base) {
                  o = window.ecwid_script_base
                  return o
                }
                function e(a) {
                  ...
                  return d >= _ ? a.substring(_, d + ab) : hb
                }
                function f(a) {
                  if (a.match(/^\w+:\/\//)) {
                  } else {
                    var b = q.createElement(Jb)
                    b.src = a + Kb
                    a = e(b.src)
                  }
                  return a
                ...
                function h() {
                  var a = q.getElementsByTagName(mb)
                  for (var b = _; b < a.length; ++b) {
                ...
                function j() {
                  var a = q.getElementsByTagName(Nb)
                  if (a.length > _) {
                    return a[a.length - ab].href
                  }
                  return hb
                }
                function k() {
              ...
              function I() {
                ...
                function h(a, b) {
                  var c = f
                  for (var d = _, e = a.length - ab; d < e; ++d) {
                    c = c[a[d]] || (c[a[d]] = [])
                  }
                  c[a[e]] = b
                }
                ...
                k[Pb] = function () {
                  ...
                  if (
                    (function () {
                      return a.indexOf(Sb) != -1 && b >= Wb && b < Tb
                    })()
                  )
                    return Xb
                  if (
                ...
                j[Pb] = { gecko1_8: _, ie10: ab, ie8: dc, ie9: ec, safari: fc }
                ...
                try {
                  ...
                  var n = m.indexOf(nc)
                  if (n != -1) {
                    g = parseInt(m.substring(n + ab), lb)
                    m = m.substring(_, n)
                  }
                } catch (a) {}
              ...
              if (p) {
                ...
                if (L && M()) {
                  ...
                  if (!/^https:\/\/\w+.local.ecwid.com(:\d+)?\/.*$/.test(O)) {
                  ...
                  if (O && !p[N]) {
                    p[N] = true
                    p[N + xc] = G()
                    var P = q.createElement(mb)
                    P.src = O
                    var Q = q.getElementsByTagName(yc)[_]
                    Q.insertBefore(P, Q.firstElementChild || Q.children[_])
                    return false
                  }
                }
              }
              ...
              if (window.needLoadEcwidAsync) {
                D(K)
                if (!!window.allowGWTAppResurrection) {
                  R(function () {
                    S(function () {
                      T()
                    })
            ...
            ru_cdev_xnext_legacyfrontend_LegacyFrontend = function () {
              var U = "bootstrap",
                V = "begin",
                W = "gwt.codesvr.ru.cdev.xnext.legacyfrontend.LegacyFrontend=",
                X = "gwt.codesvr=",
                Y = "ru.cdev.xnext.legacyfrontend.LegacyFrontend",
                Z = "startup",
                $ = "DUMMY",
                _ = 0,
                ab = 1,
                ...
                nb = "function",
                ob = "javascript",
                pb = "ru_cdev_xnext_legacyfrontend_LegacyFrontend",
                qb = "Failed to load ",
                rb = "moduleStartup",
                sb = "scriptTagAdded",
                tb = "moduleRequested",
                ub = "meta",
                vb = "name",
                wb = "ru.cdev.xnext.legacyfrontend.LegacyFrontend::",
                xb = "::",
                yb = "gwt:property",
                zb = "content",
                Ab = "=",
                ...
                Kb = "clear.cache.gif",
                Lb = "baseUrl",
                Mb = "ru.cdev.xnext.legacyfrontend.LegacyFrontend.nocache.js",
                Nb = "base",
                Ob = "//",
                Pb = "user.agent",
                Qb = "webkit",
                ...
                ic = "0591825E79DAB0259C1FAFBC6ABC0B64",
                jc = "70086A8A8FE79279A0074D843E8339B1",
                kc = "8B92C0A833B71C70E20C00294311033F",
                lc = "D83AD23056830656E54C615AFC9BCBCD",
                mc = "FB7680288180982A32FF8C3EABA9C30F",
                nc = ":",
                oc = ".cache.js",
                pc = "loadExternalRefs",
                qc = "end",
              ...
              var u = (p.__gwt_activeModules = p.__gwt_activeModules || {})
              u[Y] = { moduleName: Y }
              ru_cdev_xnext_legacyfrontend_LegacyFrontend.__moduleStartupDone = function (
                e
              ) {
                var f = u[Y].bindings
                u[Y].bindings = function () {
              ...
              ru_cdev_xnext_legacyfrontend_LegacyFrontend.__startLoadingFragment = function (
                a
              ) {
                return H(a)
              }
      ...
      _onComplete: function () {
        setTimeout(function () {
          ...
          function attachAllAppsScripts() {
            ...
            EcwidLogger.log(
              "Installed apps " +
                Ecwid._map(appsWithJsUrl, function (appData) {
                  return appData.namespace
                })
            )
            EcwidLogger.log(
              "Enabled apps " +
                Ecwid._map(enabledAppsWithJsUrl, function (appData) {
                  return appData.namespace
                })
            )
          }
      ...
      _isNeedLogIntrospectionCalls: function () {
        return false
      },
    }
    ...
    if (!Ecwid._isNewStorefrontOnly()) {
      xInjectJs(
        "https://d2scn539ulxr09.cloudfront.net/static/br/2021-21912-g057d6ac719e/lang/en.js"
      )
    }
    xInjectJs(
      "https://d3dq8sxcny4hg.cloudfront.net/states.js?hc=264330282&callback=window.ecwid_states_data.loaded"
    )
    ...
    window.ecwid_script_base =
      "https://d2scn539ulxr09.cloudfront.net/static/br/2021-21912-g057d6ac719e/"
    ...
    window.xnext_ownerId = 61271341
    ;(window.Ecwid.publicToken = "public_8tK2Yqwa2spBYKkCX55iEtW1vdYjjRQu"),
    ...
    ;(function () {
      ...
      var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=61271341"
      xInjectJs(
    ...
    window.Ecwid.getAppPublicToken = function (namespace) {
      var tokenMap = {
        "custom-app-61271341-1": "public_iNxZWDXrKMZrzGkdBWk3fvcfaJhBVgcm",
        "easy-upsell-dev": "public_2ydXBTZWhi7MAQQYj1U25UQgtTYVQGkq",
        "ecwid-storefront": "public_8tK2Yqwa2spBYKkCX55iEtW1vdYjjRQu",
      }
    ...
    function xAddWidget(widgetType, args) {
      ...
      if (widgetType == "ProductBrowser" || widgetType == "Categories") {
        ecwid_loader(id)
      }
      var l = 0
...
window.Ecwid.getAppPublicConfig = function (namespace) {
  var publicData = {
    "ecwid-android-app": "{}",
    "custom-app-61271341-1": "{}",
    "easy-upsell-dev":
      '{"cashOnDelivery":"true","condition":"NEW","globalShippingRate":"true","freeShippingRate":"false"}',
    "ecwid-degenerator-app": "{}",
    "storefront-label-editor":
      "%7B%22en%22%3A%7B%22Account.ShoppingCart.empty%22%3A%22Your%20shopping%20cart%20is%20empty.%22%2C%22CartPage.Checkout.secure_notice%22%3A%22All%20data%20is%20transmitted%20encrypted%20via%20a%C2%A0secure%20TLS%20connection.%20Payment%20safely%20processed%20via%20PayPal%20%26%20Stripe.%22%2C%22CartPage.ContinueShopping.description%22%3A%22%22%2C%22CartPage.Email.title%22%3A%22%22%2C%22CartPage.EmailMarketingConsent.agree%22%3A%22Keep%20me%20up%20to%20date%20on%20news%2C%20exclusive%20offers%20and%20updates%22%2C%22CartPage.EmptyState.label%22%3A%22Your%20shopping%20cart%20is%20empty.%22%2C%22CartPage.NextSteps.Confirmation.description%22%3A%22Files%20immediately%20available%20for%20download%20upon%20purchase.%22%2C%22CartPage.NextSteps.Confirmation.title%22%3A%22Download%22%2C%22CartPage.NextSteps.Payment.description%22%3A%22Quick%20and%20safe%20checkout%20via%20PayPal%20or%20credit%2Fdebit%20card%20(processed%20by%20Stripe).%20%22%2C%22CartPage.NextSteps.Payment.title%22%3A%22Proceed%20to%20Pay%22%2C%22PaymentMethod.credit_card%22%3A%22Credit%20or%20debit%20card%20(Stripe)%22%7D%7D",
    "starter-site": "{}",
    "ecwid-vuega-app": "{}",
    "ecwid-storefront": "{}",
  }
