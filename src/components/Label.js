...
export default function Label(props) {
  console.log(props)
  const youSave = () => {
    const total = props.rawComparePrice - props.rawPrice
  ...
  return (
    <div className="discount Label--sale">
      <div className="Label-svg mo-fire">
        <svg
          version="1.1"
          id="Layer_1"
	...
	S134.387,164.603,103.143,105.917z"
      ...
      <span className="CustomLabel-text">{youSave()} OFF</span>
    </div>
  )
}
