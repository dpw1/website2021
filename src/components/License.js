    ...
    <section className="License">
      <div className="container">
        ...
        <div className="License-text">
          ...
          <ol>
            <li>
              6. Additional customizations to any EZFY plugin have additional
              fees. This amount is subjective to the quantity and complexity of
              the customizations requested.
              <br />
            </li>
            <li>
              7. All of our plugins ship with the Javascript code obfuscated.
            </li>
          </ol>
          <p>
